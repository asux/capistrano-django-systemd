Gem::Specification.new do |s|
  ...
  s.summary  = 'capistrano-django-systemd - Welcome to easy deployment with Ruby over SSH for Django/Python using Gunicorn'
  s.description = 'capistrano-django-systemd provides a solid basis for common django deployment'
